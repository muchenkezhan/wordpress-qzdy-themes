...
<li><i class="layui-icon layui-icon-log"></i><?php the_time('Y/n/j '); ?></li><li><i class="layui-icon layui-icon-user"></i><a><?php global $current_user; get_currentuserinfo();  echo $current_user->nickname;?></a></li><li><i class="layui-icon layui-icon-fire"></i><span class="view"><?php post_views(' ', ''); ?></span></li></div></div></div>
          <?php endwhile; else: ?>
