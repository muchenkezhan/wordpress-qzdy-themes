...
<?php } ?>
    <div class="layui-col-md9 layui-col-lg9">
        ...
        <div class="title-article">
            <h1><?php the_title(); ?></h1>
            <div class="title-msg">
                <span><i class="layui-icon layui-icon-username"></i>沐辰客栈</span>
                <span><i class="layui-icon layui-icon-time"></i><?php the_time(' Y/n/j '); ?></span>
                <span><i class="layui-icon layui-icon-fire"></i><?php post_views(' ', ''); ?>℃</span>
                <span><?php edit_post_link('[编辑]'); ?></span>
                <!--<span><i class="layui-icon iconfont icongangbi"></i>1852字数</span>-->
                <!--<span class="meta-value"><i class="layui-icon iconfont iconbaidu"></i><span id="Joe_Baidu_Record" style="color: rgb(103, 194, 58);">已收录</span></span>-->
            </div>
        </div>
