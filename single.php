...
<?php the_content(); ?>
	...
	if(!empty($zero_footer_grxx = _qzdy('zero-footer-grxx'))){?>
            <div class="author-row ">
                ...
                <div class="author-box flex-row align-center" data-v-730707dd=""><img src="<?php echo _qzdy('zero-footer-txurl');?>" alt="" class="author-img" data-v-730707dd=""> <div class="author-name" data-v-730707dd=""><p data-v-730707dd=""><?php echo _qzdy('zero-footer-txxnc');?></p> <p data-v-730707dd=""><?php the_modified_time('n月d日H:i'); ?></p></div></div>
...
<?php 
	...
	if(!empty($zero_footer_wzdata = _qzdy('zero-footer-wzdata'))){?>
            <div class="time-text">
            <i class="layui-icon iconfont iconshijian<?php echo qzdy_prevent_theme(); ?>"></i> 最后修改：<?php the_modified_time('Y年n月d日H:i'); ?></div><?php } ?>
            <!--点赞-->
<?php 
			...
			<div class="layui-col-md3 layui-col-xs6 layui-col-sm4">
				<a href="<?php the_permalink(); ?>" class="darcyq-random-link">
					...
					<div class="darcyq-random-title">
						...
						<span class=""><i class="far fa-eye"></i> <?php post_views(' ', ''); ?>℃</span>
					</div>
				</a>
			</div>
