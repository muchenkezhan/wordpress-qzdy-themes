...
if(! defined('ALLOW_EXTERNAL') )			define ('ALLOW_EXTERNAL', _qzdy('rp-timthumb-wailian-switch')?TRUE:false);						// Allow image fetching from external websites. Will check against ALLOWED_SITES if ALLOW_ALL_EXTERNAL_SITES is false
...
// If ALLOW_EXTERNAL is true and ALLOW_ALL_EXTERNAL_SITES is false, then external images will only be fetched from these domains and their subdomains. 
	if(! isset($ALLOWED_SITES)){
		...
		if(!empty(_qzdy('rp-timthumb-bai'))){
			$ALLOWED_SITES = explode(',', str_replace("，", ",", _qzdy('rp-timthumb-bai')));
		}
	}
// -------------------------------------------------------------
