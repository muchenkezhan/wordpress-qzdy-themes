...
function CID_get_flag($ip)
{
    ...
    $output = str_replace("%IMAGE_BASE%", get_stylesheet_directory_uri() . '/include/qzdyshow-ua/flags', $output);
...
function CID_unix_detect_os($ua)
{
    ...
    if (preg_match('/Linux/i', $ua)) {
        ...
        $os_name = "FreeBSD";
        $os_code = "freebsd";
        $os_before = '<span class="os os_unix"><i class="fas fa-desktop"></i>';
        ...
        $os_name = '未知操作系统';
        $os_code = 'other';
        $os_before = '<span class="os os_other"><i class="fas fa-desktop"></i>';
    }
...
function CID_detect_browser($ua)
{
    ...
    if (preg_match('#com.zhihu.android/Futureve/([a-zA-Z0-9.]+)#i', $ua, $matches)) {
        ...
        $browser_before = '<span class="ua ua_sogou"><i class="fas fa-globe"></i>';
    } elseif (preg_match('#baidubrowser ([a-zA-Z0-9.]+)#i', $ua, $matches)) {
        $browser_name = '百度浏览器';
        $browser_code = 'baidubrowser';
        $browser_ver = $matches[1];
        $browser_before = '<span class="ua ua_ucweb"><i class="fas fa-globe"></i>';
        ...
        $browser_ver = $matches[1];
        $browser_before = '<span class="ua ua_qqbrowser"><i class="fas fa-globe"></i>';
        ...
        $browser_code = 'arora';
        $browser_ver = $matches[1];
        $browser_before = '<span class="ua ua_other"><i class="fas fa-globe"></i>';
