...
class My_Widget_persona_left extends WP_Widget {
 
	function __construct()
	{
		$widget_ops = array('description' => 'Qzdy-个人信息栏二');
		$control_ops = array('width' => 400, 'height' => 300);
		parent::__construct(false,$name='Qzdy-个人信息栏二',$widget_ops);  
...
register_widget('My_Widget_persona_left');
?>