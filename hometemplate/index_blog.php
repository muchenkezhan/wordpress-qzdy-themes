...
<div class="layui-col-md9 layui-col-lg9">
    ...
    <div class="index-post-text-small<?php echo qzdy_prevent_theme(); ?>"><h2  title="<?php the_title(); ?>" class="m-t-none text-ellipsis index-post-title text-title"><?php if (is_sticky()) {echo  '<span class="layui-badge">推荐</span>';} ?><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>
    <p class="summary l-h-2x text-muted<?php echo qzdy_prevent_theme(); ?>"><?php echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 96,'…'); ?></p>
