...
<?php }?>
    ...
    <div class="index-post-text-small<?php echo qzdy_prevent_theme(); ?>"><h2  title="<?php the_title(); ?>" class="m-t-none text-ellipsis index-post-title text-title"><a href="<?php the_permalink() ?>"><?php the_title(); ?></a></h2>
    <p class="summary l-h-2x text-muted<?php echo qzdy_prevent_theme(); ?>"><?php echo mb_strimwidth(strip_tags(apply_filters('the_content', $post->post_content)), 0, 200,'…'); ?></p>
    <div class="line line-lg b-b b-light"></div>
    <div class="text-muted post-item-foot-icon text-ellipsis list-inline">
<li class="viewfloat">
